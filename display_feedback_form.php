...
<body>
    ...
    <form action="display_feedback_inner.php" method="POST">
        <table>
           <tr >
              <td style="border-bottom: 2px solid black;border-right: 2px solid black;padding:5px;">
     Department<select name="department">
        ...
        Course<select name="course">
             ...
             <td style="border-bottom: 2px solid black;padding:5px;">
